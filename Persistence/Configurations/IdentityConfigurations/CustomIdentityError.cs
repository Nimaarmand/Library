...
namespace Persistence.Configurations.IdentityConfigurations
{
    public class CustomIdentityError : IdentityErrorDescriber
    {
        ...
        public IdentityError TwoFactorCodeNotValid()
        {
            return new IdentityError
            {
                Code = nameof(TwoFactorCodeNotValid),
                Description = "کد دو مرحله‌ای نامعتبر است."
            };
        }
        public IdentityError PasswordChangeFailed()
        {
            return new IdentityError
            {
                Code = nameof(PasswordChangeFailed),
                Description = "تغییر کلمه عبور ناموفق بود."
            };
        }
        public IdentityError EmailConfirmationFailed()
        {
            return new IdentityError
            {
                Code = nameof(EmailConfirmationFailed),
                Description = "تأیید ایمیل ناموفق بود."
            };
        }
    }
}
